...
const UsernameModal: React.FC<{
    onComplete: (username: string, referralCode?: string) => Promise<void>;
    isLoading: boolean;
    ...
    const handleComplete = async () => {
      if (username.trim().length >= 3) {
        await onComplete(username.trim(), referralCode.trim() || undefined);
      }
    };
        ...
        >
          <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', paddingHorizontal: 16 }}>
            <View className="items-center">
              {/* Header */}
              <Text
                className="mb-8 text-base leading-6 font-arcade text-secondary"
              ...
              {/* Username Input Box */}
              <View className="w-full border-2 border-cyan-400 rounded-lg bg-[#1a1f3a] p-4 mb-4">
              ...
              <View className="w-full border-2 border-purple-400 rounded-lg bg-[#1a1f3a] p-4 mb-4">
                <Text className="mb-2 font-mono text-xs font-semibold text-purple-400">
                ...
                <TextInput
                  ...
                  editable={!isLoading}
                  className="rounded border border-purple-400 bg-[#2a2f4a] px-3 py-2 font-mono text-base text-white"
                />

                <Text className="mt-2 font-mono text-xs text-gray-600">
                  Get bonus points when you reach 50 points!
                </Text>
              </View>
              ...
              <TouchableOpacity
                ...
                className={`w-full rounded py-3 items-center ${
